...
const TECH_COLORS: Record<string, { color: string; bg: string; border: string }> = {
  ...
  Swagger:              { color: '#34d399', bg: 'rgba(52,211,153,0.08)', border: 'rgba(52,211,153,0.25)' },
  'Docker básico':      { color: '#38bdf8', bg: 'rgba(56,189,248,0.08)', border: 'rgba(56,189,248,0.28)' },
  'Responsive Design':  { color: '#94a3b8', bg: 'rgba(148,163,184,0.06)', border: 'rgba(148,163,184,0.22)' },
};
